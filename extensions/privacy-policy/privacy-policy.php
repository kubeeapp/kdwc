...
function privacy_on_admin_init(){
    ...
    if( function_exists('wp_add_privacy_policy_content') ) {
        wp_add_privacy_policy_content(
            __('Kd-Wc Dynamic Content', 'kd-wc'),
            __("While it is your responsibility to publish a privacy policy abiding by all relevant data protection laws, at Kd-Wc we’re happy to provide you with some guidance on adjustments to make, upon installing our dynamic content. <br /> <br />
