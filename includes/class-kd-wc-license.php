...
class Kd_Wc_License {
	...
	private static function _query_kdwc_api($edd_action, $license, $item_id) {
        require_once plugin_dir_path( __FILE__ ) . 'class-kd-wc.php';
	...
	public static function deactivate_license($license, $item_id) {
		return self::_query_kdwc_api('deactivate_license', $license, $item_id);
	}

	public static function activate_license($license, $item_id) {
		return self::_query_kdwc_api('activate_license', $license, $item_id);
	}
