...
namespace KDWC\Services\PluginSettingsService;
...
class PluginSettingsService {
	...
	const PAGES_VISITED_OPTION =
		'kdwc_settings_page_pages_visited_option';
	const REMOVE_PLUGIN_DATA_OPTION =
		'kdwc_settings_page_remove_data_on_uninstall_option';
	const APPLY_THE_CONTENT_FILTER_OPTION =
		'kdwc_settings_page_apply_the_content_filter_option';
	const REMOVE_AUTO_P_TAG_OPTION =
		'kdwc_settings_page_remove_auto_p_tag_option';
	const ALLOW_FRAGMENTED_CACHE =
		'kdwc_settings_page_allow_fragmented_cache_option';
	const REMOVE_COOKIE =
		'kdwc_settings_pages_remove_visits_cookie_option';
	const ALLOW_SHORTCODES =
		'kdwc_settings_pages_allow_shortcodes_option';
	const DISABLE_CACHE =
		'kdwc_settings_pages_disable_cache_option';
    const AJAX_ANALYTICS =
        'kdwc_settings_pages_analytics_with_ajax_option';
    const DISABLE_ANALYTICS =
        'kdwc_settings_pages_analytics_enabled_option';
    const USER_GROUP_LIMIT =
        'kdwc_settings_pages_user_group_limit_option';
    const GROUPS_COOKIE_LIFESPAN =
        'kdwc_settings_pages_groups_cookie_lifespan';
    const RENDER_TRIGGERS_VIA_AJAX =
        'kdwc_settings_page_render_triggers_via_ajax_option';
	...
	public function settings_page_update() {
		if( isset( $_POST['kdwc_settings_page_update'] ) ) {
...
class KdWcSettingsPagesVisitedOption
	...
	public function apply( $post ) {
		$postName_Type = 'kdwc_settings_pages_visited_type';
		$postName_Value = 'kdwc_settings_pages_visited_value';
