(function ($) {
    ...
    $(document).ready(function () {
        ...
        if ($('#kdwc_send_test_email').length > 0) {
            $('#kdwc_send_test_email').on('click', function () {
...
function getAnalyticsData(postid) {
    ajaxPost({action: 'kdwc_analytics_req', an_action: 'getFields', postid: postid}, buildAnalyticsDisplay)
}
...
function resetAllFields() {
    if (confirm('Are you sure you want to reset this trigger stats?')) {
        ajaxPost({action: 'kdwc_analytics_req', an_action: 'resetFields', postid: pid}, function () {
