<?php
/**
 *The main service for working with kd-wc groups
 *
 * @author Nick Martianov
 *
 **/

namespace KDWC\PublicFace\Services\GroupsService;

require_once(IFSO_PLUGIN_BASE_DIR . 'services/plugin-settings-service/plugin-settings-service.class.php');

use KDWC\Services\PluginSettingsService\PluginSettingsService as SettingsService;

use KDWC\PublicFace\Services\TriggersService\TriggerContextLoader as ContextLoader;

class GroupsService{
    private static $instance;

    private $groups_data_option_name = 'kdwc_groups_data';

    private $groups_cookie_name = 'kdwc_group_name';
