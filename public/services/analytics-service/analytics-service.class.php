...
class AnalyticsService {
    ...
    private $trigger_rules_field_name = 'kdwc_trigger_rules';

    public $last_viewed_version_cookie_name = 'kdwc_last_viewed';

    public $currently_viewing_cookie_name = 'kdwc_viewing_triggers';
    ...
    private function get_default_an_data($postid){
        ...
        $this->trigger_rules_field_name = 'kdwc_default_analytics';
