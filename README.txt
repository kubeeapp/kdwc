...
<a href="https://www.kdwc.com?utm_source=WordPress&utm_medium=Readme&utm_campaign=1.4.0&utm_term=DemoAndFriendlyExp" target="_blank">- See how it works</a>
...
= What is KDWC? (Summary) =

**An easy way to improve conversions, engagement, sales, and bounce rates.**

KDWC allows you to add or replace content on your website based on the visitors’ profile or interaction with the site. Using dynamic, personalized content your visitors will engage,
convert and buy more!	


    
    
= WHICH CONDITIONS CAN BE SET WITH kdwc? =
...
<a href="https://www.kdwc.com?utm_source=WordPress&utm_medium=Readme&utm_campaign=1.3.1&utm_term=AboutTheConditions" target="_blank">**- Learn more about the conditions**</a>

= HOW IT WORKS =

Creating a dynamic trigger with kdwc is very simple:
...
= WHAT CONTENT CAN BE CUSTOMIZED WITH kdwc? =
kdwc allows you to customize any element on the website, including titles, texts, images, videos, menu items, and design.


**Immidiate improve in your website conversion rate! Download kdwc now to see how it works on your website.**
...
1. Enter "kdwc" as a search term and click "Search Plugins"
1. Download and install the KDWC Dynamic Content plugin
1. Click the "Activate Plugin" link
1. On your WordPress menu under KDWC, click "Add new"
...
kdwc Dynamic Content is a WP Plugin allowing site administrators to personalize their website content according to a predefined set of conditions (rules). 

 
= How does If>So work? =

kdwc is very simple to use. All you have to do is select a condition (rule), set the content you would like to display if it is met, and set default content to be displayed when it is not.
...
<a href="https://www.kdwc.com?utm_source=WordPress&utm_medium=Readme&utm_campaign=1.3.1&utm_term=ComleteListConditions" target="_blank">**click here for the complete list of conditions**</a>

= Can I use If>So WP Plugin with any WordPress theme? = 

You sure can! So far, we have not come across any WordPress themes that kdwc Dynamic Content can not working with. If for any reason it doesn’t work with your theme, we will work with you to resolve the issue.
...
= 1.4.5 =
* If used in the page title, kdwc’s shortcodes are now also rendered in the meta title of the page.
...
* Settings - An option to prevent WordPress from wrapping kdwc shortcodes with <p> tags was added.
* Settings - An option to choose not to remove kdwc's data when the plugin is deleted was added.
