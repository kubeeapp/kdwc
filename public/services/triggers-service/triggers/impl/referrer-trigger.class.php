...
class ReferrerTrigger extends TriggerBase {
	...
	public function handle($trigger_data) { //$trigger_data == All the values from the associative array originated in class-kd-wc-setting.php - the SETTED one is triggerred - at this "contains" case it sets one value of the array to: "contains"["compare"]=> string(5) "kd-wc". muliCohen.
