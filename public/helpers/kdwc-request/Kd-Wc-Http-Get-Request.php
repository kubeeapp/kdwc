<?php
/**
 *Models a request to be passed to the context of the trigger service to allow kd-wc's triggers to work on current request or passed request passed via AJAX
 *
