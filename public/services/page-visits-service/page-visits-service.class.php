...
use KDWC\Services\PluginSettingsService\PluginSettingsService;
...
class PageVisitsService {
	...
	private function __construct() {
        ...
        $this->cookie_name = 'kdwc_page_visits';
	...
	private function delete_cookie() {
			unset($_COOKIE['kdwc_page_visits']);
			setcookie('kdwc_page_visits', '', 1, '/');
		}
