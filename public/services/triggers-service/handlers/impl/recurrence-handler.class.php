...
use KDWC\PublicFace\Services\RecurrenceService;
...
class RecurrenceHandler extends ChainHandlerBase {
	public function handle($context) {
		...
		if (isset($_COOKIE["kdwc_recurrence_session_" . $trigger_id])) {
			
			$session_cookie_for_trigger_id_json = 
				stripslashes($_COOKIE["kdwc_recurrence_session_" . $trigger_id]);
		...
		if ( isset($_COOKIE['kdwc_recurrence_data']) ) {
			$recurrence_data_json = stripslashes($_COOKIE['kdwc_recurrence_data']);
